...
export const ERROR_PROMPT_MAP = {
	...
	application: {
		...
		error_create_file: {
			...
			code: "FILE",
			labels: ["Error creating file!", "Ошибка создания файла!", "Faylni yozishda xatolik!"],
		},
		error_delete_file: {
			id: 10003,
			status: "INTERNAL SERVER ERROR",
			...
			labels: [
				...
				"Faylni olib tashlashda xatolik!",
			],
		},
		cannot_do_action: {
			id: 10004,
		...
		invalid_token: {
			...
			status: "BADREQUEST",
			code: "ADMIN",
			labels: ["Invalid token!", "Недействительный токен!", " Noto'g'ri token!"],
		},
		not_verified_user: {
			id: 10006,
			status: "BADREQUEST",
			...
			labels: [
				...
				"Foydalanuvchi verifikatsiyadan o'tmagan!",
			],
		},
...
export const errorPrompt = {
	codeExpiredOrNotFoundError: {
		status: "BAD_REQUEST",
		message: {
			uz: "Tasdiqlash koditopilmadi yoki muddati tugadi!",
	...
	codeAlreadyExists: {
		status: "BAD_REQUEST",
		message: {
			uz: "Tasdiqlash kodi allaqachon yuborilgan!",
			ru: "Код подтверждения уже отправлен!",
		},
	},
	...
	codeNotVerified: {
		status: "BAD_REQUEST",
		message: {
			uz: "Tasdiqlash kodi yuborilmagan!",
			ru: "Код подтверждения не отправлен!",
		},
	},
	...
	cannotDoAction: {
		status: "NOT FOUND",
		message: {
			uz: "Olib bo'lmaydi, bunday yo'l yo'q!",
			ru: "Не могу добраться, нет такого маршрута!",
		},
	},
	...
	usernameAlreadyExists: {
		status: "CONFLICT",
		message: {
			uz: "Username allaqachon mavjud!",
			ru: "Username уже существует!",
		},
	},
	usernameOrPasswordIncorrect: {
		...
		message: {
			...
			ru: "Username или пароль неправильный!",
		},
	},
	authorizationError: {
		status: "AUTH ERROR",
	...
	notFound: {
		status: "NOT FOUND",
		message: {
			uz: "Bunday id li ma'lumot topilmadi!",
			ru: "Запись с таким ID не найдена!!",
		},
	},
	userNotFound: {
		status: "NOT FOUND",
